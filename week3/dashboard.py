...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, names='class', title='Total Success Launch for site ' + entered_site)
        return fig
...
def get_scatter_chart(site,payload):
    ...
    if site == 'ALL':
        fig = px.scatter(filtered_payload_df, x='Payload Mass (kg)', y='class', color='Booster Version Category')
        return fig
    else:
        filtered_df = filtered_payload_df[filtered_payload_df['Launch Site'] == site]
